...
const Child = ({ child }) => {
    ...
    >
        <Pressable style={styles.child}>
            ...
            <Icon name="chevron-thin-right" type='Entypo' size={22} color={"#000"} />
        </Pressable>
    </Ripple>
}
        ...
        >
            <View style={{
                ...
                <Text style={{
                    ...
                    color: "#fff"
                }}>list of registered child</Text>
                <Pressable>
                    <Icon name='menu' type='Ionicons' size={MetricsSizes.large} color={Colors.white} />
                </Pressable>
            </View>
            <ScrollView style={{
                paddingHorizontal: 10,
